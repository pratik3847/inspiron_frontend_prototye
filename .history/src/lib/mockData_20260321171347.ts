...
export const reports: ReportItem[] = [
  {
    ...
    description: '837I + 837P claims processed from the dataset zip.',
    generatedAt: '2026-03-21 12:35',
    status: 'ready',
    format: 'pdf',
    metrics: [
      ...
      { label: 'Total Amount', value: '$5,300' },
    ],
  },
  {
    id: 'rpt-remit-001',
    title: 'Remittance Payment Report',
    description: '835-style payment rollup inferred from dataset claims.',
    generatedAt: '2026-03-21 12:37',
    status: 'ready',
    format: 'csv',
    metrics: [
      { label: 'Payments', value: '2' },
      { label: 'Paid', value: '$5,050' },
      { label: 'Adjustments', value: '$250' },
      { label: 'Partial', value: '1' },
    ],
  },
  {
    id: 'rpt-enroll-001',
    title: 'Enrollment Activity Report',
    description: '834 enrollment snapshot from the dataset zip.',
    generatedAt: '2026-03-21 12:40',
    status: 'ready',
    format: 'pdf',
    metrics: [
  ...
  },
  {
    ...
    description: 'Validation checks from dataset segments.',
    generatedAt: '2026-03-21 12:41',
    status: 'ready',
    format: 'pdf',
    metrics: [
